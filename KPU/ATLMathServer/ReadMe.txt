========================================================================
    ACTIVE TEMPLATE LIBRARY : ATLMathServer Project Overview
========================================================================

AppWizard has created this ATLMathServer project for you to use as the starting point for
writing your Dynamic Link Library (DLL).

This file contains a summary of what you will find in each of the files that
make up your project.

ATLMathServer.vcxproj
    This is the main project file for VC++ projects generated using an Application Wizard.
    It contains information about the version of Visual C++ that generated the file, and
    information about the platforms, configurations, and project features selected with the
    Application Wizard.

ATLMathServer.vcxproj.filters
...
ATLMathServer.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (ATLMathServer.h)
        GUID definitions                                (ATLMathServer_i.c)
        A type library                                  (ATLMathServer.tlb)
        Marshaling code                                 (ATLMathServer_p.c and dlldata.c)

ATLMathServer.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in ATLMathServer.idl. It will be regenerated by MIDL during compilation.
...
StdAfx.h, StdAfx.cpp
    ...
    named ATLMathServer.pch and a precompiled types file named StdAfx.obj.
...
ATLMathServerps.vcxproj
	...
	dlldata.c, ATLMathServer_i.c and ATLMathServer_p.c which are required
	to build the proxy/stub DLL.

ATLMathServerps.vcxproj.filters
